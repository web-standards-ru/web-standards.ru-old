...
- css
- methods
date: 2013-12-10 07:26:44+03:00
---

Перед вами перевод первой главы книги «[Sass For Web Designers](http://www.abookapart.com/products/sass-for-web-designers)» Дэна Седерхольма, которая вышла в серии A Book Apart. В числе [других книг](http://web-standards.ru/books/), мы рекомендуем эту для введения в CSS-препроцессоры. — Прим. редактора.
...
Почему CSS имеет такие синтаксические ограничения, мы можем попытаться узнать из эссе соавтора CSS Берта Боса ([bkaprt.com/sass/3/](http://bkaprt.com/sass/3/)):
...
Краткое описание Sass ([bkaprt.com/sass/4/](http://bkaprt.com/sass/4/)) с сайта технологии:
...
Перевод оригинальной статьи «[Why Sass?](http://alistapart.com/article/why-sass)» Дэна Седерхольма (Dan Cederholm), опубликованной на сайте [A List Apart](http://alistapart.com/). Переведено и опубликовано с разрешения автора.
