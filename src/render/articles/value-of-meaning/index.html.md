...
slug: value-of-meaning
tags:
- html
- opinion
- semantics
date: 2012-08-08 23:43:48+03:00
---

[![](http://static.web-standards.ru/articles/value-of-meaning/comic.png)](http://static.web-standards.ru/articles/value-of-meaning/comic.png)
...
Если кратко пересказать все тезисы статьи Дивьи (лучше [прочитайте её сами](http://web-standards.ru/articles/pointless-semantic/), чем доверяйтесь моему пересказу, который в любом случае будет крайне упрощенным), то они состоят в том, что мы не должны забивать себе голову семантикой, потому что:
