...
slug: small-hr-elements
tags:
- html
- html5doctor
- semantics
date: 2011-05-30 06:55:52+03:00
---

Не так давно мы писали [о презентационных элементах `<i>` и `<b>`](http://web-standards.ru/articles/i-b-em-strong-elements/) из HTML4, возродившихся к новой семантической жизни. Другие два элемента, которые претерпели изменения, чтобы получить значения в HTML5 — это `<small>` и `<hr>`:
...
![Оформление <hr> в виде вензеля](http://static.web-standards.ru/articles/small-hr-elements/hr-separator.png)
...
![Неподходящий случай для использования <hr> на Cork’d.com](http://static.web-standards.ru/articles/small-hr-elements/corkd.png)
