...
slug: css-techniques-p1-tables
tags:
- css
- html
- coding
- methods
date: 2013-06-27 11:37:46+03:00
---
...
![](http://static.web-standards.ru/articles/css-techniques/logo-n-menu.svg) Дизайнер может желать, чтобы логотип и меню всегда умещались в одной строчке. Таблица не может обрезать длинные надписи для этой цели.
...
![](http://static.web-standards.ru/articles/css-techniques/table-form.svg) Таблица позволяет легко и надёжно выровнять заголовки и элементы форм по базовой линии
...
О других приёмах и возможностях CSS 2.1 без использования таблиц читайте во второй части статьи «[Бестабличная вёрстка](http://web-standards.ru/articles/css-techniques-p2-alternate/)».
