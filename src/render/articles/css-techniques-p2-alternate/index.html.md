...
slug: css-techniques-p2-alternate
tags:
- css
- html
- coding
- methods
date: 2013-06-28 08:39:30+03:00
---
...
![](http://static.web-standards.ru/articles/css-techniques/floats.svg)
Пример возможного расположения произвольных обтекаемых блоков
...
![](http://static.web-standards.ru/articles/css-techniques/float-how.svg)
Принцип работы обтекаемых блоков. Адаптированная иллюстрация из спецификации
...
![](http://static.web-standards.ru/articles/css-techniques/float-overflow.svg)
...
![](http://static.web-standards.ru/articles/css-techniques/mail-folders.svg)
...
В особенной модели Internet Explorer 7 и ниже строчные блоки — это обычные строчные элементы, у которых есть свойство _hasLayout_. Правило `display: inline-block` включает именно это свойство, но эффект достигается только на строчных элементах. Блочным элементам требуется задать `display: inline` и включить hasLayout другим способом: например, с помощью `zoom: 1`, или вынести объявление `display: inline-block` в отдельный блок правил.
...
![](http://static.web-standards.ru/articles/css-techniques/inline-blocks.svg)
Пример возможного расположения строчных блоков
...
![](http://static.web-standards.ru/articles/css-techniques/inline-justifying.svg)
...
![](http://static.web-standards.ru/articles/css-techniques/inline-centering.svg)
...
![](http://static.web-standards.ru/articles/css-techniques/position-aligning.svg)
Выравнивание абсолютно позиционированного блока между заданнами координатами с `margin: auto`
...
![](http://static.web-standards.ru/articles/css-techniques/position-filling.svg)
...
![](http://static.web-standards.ru/articles/css-techniques/position-stacking.svg)
...
![](http://static.web-standards.ru/articles/css-techniques/position-stacking-context.svg)
