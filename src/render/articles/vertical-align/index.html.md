...
tags:
- css
date: 2012-03-09 11:07:02+03:00
---
...
![](http://static.web-standards.ru/articles/vertical-align/vertical-align.png)

[А вот пример](http://jsbin.com/isuvob/edit#html,live), в котором есть несколько строчных элементов, один из которых прижат к верху.
...
Взгляните [на пример](http://jsbin.com/apiqog/edit#html,live), где я увеличил размер шрифта так, чтобы размер _x-height_ стал гораздо больше. После этого станет понятно, что значение `middle` не получится использовать очень часто.
